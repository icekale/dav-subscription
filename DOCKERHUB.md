...
- **动态**：已订阅大V的最新帖时间流
- **我的订阅**：管理订阅，标星特别关注 ⭐
- **推送设置**：绑定 Telegram / 飞书 / 企业微信 / Bark 渠道，生成绑定码把机器人会话合并到网页账号，自选接收通道
...
- **X 抓不到？** 配置 `TWITTER_COOKIE`；直抓失败会自动降级内置 RSSHub 备用通道
